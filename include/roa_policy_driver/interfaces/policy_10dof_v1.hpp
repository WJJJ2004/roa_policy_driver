...
struct Policy10DofV1 {
  static constexpr int kDof = 10;
  static constexpr int kObsDim = 36;  // 3 + 10 + 10 + 3 + 10
  static constexpr int kActDim = 10;
  ...
  // Pack order: cmd(3), q_rel(10), qd_rel(10), imu(3), last_action(10)
